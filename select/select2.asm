...
; Ä		 Ä  I_WORKSPACE=1 Ä  I_WORKSPACE=2 Ä  I_WORKSPACE=3 Ä
; ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
; Ä P_BREAK	 Ä  'ON'          Ä  'ON'          Ä  'ON'          Ä
; Ä P_BUFFERS	 Ä  ' '           Ä  '20'          Ä  '50,4'        Ä
; Ä P_CPSW	 Ä  'OFF'         Ä  'OFF'         Ä  'OFF'         Ä
; Ä F_CPSW	 Ä  no		  Ä  no 	   Ä  no	    Ä
; Ä P_FCBS	 Ä  ' '           Ä  ' '           Ä  '20,8'        Ä
; Ä P_FILES	 Ä  '8'           Ä  '20'          Ä  '20'          Ä
; Ä P_LASTDRIVE  Ä  'E'           Ä  'E'           Ä  'E'           Ä
; Ä P_STACKS	 Ä  ' '           Ä  ' '           Ä  ' '           Ä
; Ä P_VERIFY	 Ä  'OFF'         Ä  'OFF'         Ä  'OFF'         Ä
; Ä P_PROMPT	 Ä  '$P$G'        Ä  '$P$G'        Ä  '$P$G'        Ä
; Ä F_PROMPT	 Ä  no		  Ä  no 	   Ä  no	    Ä
; Ä P_PATH	 Ä  ' '           Ä  ' '           Ä  ' '           Ä
; Ä F_PATH	 Ä  no		  Ä  no 	   Ä  no	    Ä
; Ä P_APPEND	 Ä  ' '           Ä  ' '           Ä  ' '           Ä
; Ä F_APPEND	 Ä  no		  Ä  no 	   Ä  no	    Ä
; Ä P_ANSI	 Ä  ' '           Ä  ' '           Ä  '/X'          Ä
; Ä F_ANSI	 Ä  no		  Ä  yes	   Ä  yes	    Ä
; Ä P_FASTOPEN	 Ä  ' '           Ä  'C:=(50,25)'  Ä  'C:=(100,200)'Ä
; Ä F_FASTOPEN	 Ä  no		  Ä  yes	   Ä  yes	    Ä
; Ä F_GRAFTABL	 Ä  no		  Ä  no 	   Ä  no	    Ä
; Ä P_GRAPHICS	 Ä  ' '           Ä  ' '           Ä  ' '           Ä
; Ä F_GRAPHICS	 Ä  no		  Ä  yes	   Ä  yes	    Ä
; Ä P_SHARE	 Ä  ' '           Ä  ' '           Ä  ' '           Ä
; Ä F_SHARE	 Ä  no		  Ä  no 	   Ä  no	    Ä
; Ä P_SHELL	 Ä  '/R'          Ä  '/R'          Ä  '/R'          Ä
; Ä F_SHELL	 Ä  yes 	  Ä  yes	   Ä  yes	    Ä
; Ä P_VDISK	 Ä  ' '           Ä  ' '           Ä  ' '           Ä
; Ä F_VDISK	 Ä  no		  Ä  no 	   Ä  no	    Ä
; Ä P_XMAEM	 Ä  ' '           Ä  ' '           Ä  ' '           Ä
; Ä DOS_LOC	 Ä  'DOS'         Ä  'DOS'         Ä  'DOS'         Ä
; Ä F_XMA	 Ä  yes 	  Ä  yes	   Ä  yes	    Ä
; Ä P_XMA2EMS	 Ä  'FRAME=D000 P254=C800 P255=CC00' for all optionsÄ
...
;  Ä LOAD_KEYBOARD			 Ä
;
;  Ä	This will execute the keyboard	 Ä
;	program to load the requested
;  Ä	keyboard routine.		 Ä
;   Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä Ä
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
LOAD_KEYBOARD:							;AN000;
